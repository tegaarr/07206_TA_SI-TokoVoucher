        ...
        <div class="container">
            <div class="card mt-5">
                <div class=" card-header">
                    <h2>Data Pembeli</h2>
                    <a href="index.php?page=admin&aksi=daftarPembeli" class="btn btn-success float-right">Tambah Data Pembeli</a>
                </div>
                <div class="card-body">
                    ...
                    <table class="table table-striped table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                <a href="index.php?page=pembeli&aksi=edit&id_pembeli=<?=$row['id_pembeli']?>" class="btn btn-warning">Edit</a>
